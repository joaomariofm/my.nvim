...
_G.packer_plugins = {
  ...
  copilot = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/copilot",
    url = "https://github.com/github/copilot.vim"
  },
  goyo = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/goyo",
  ...
  ["markdown-preview.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/dev/.local/share/nvim/site/pack/packer/opt/markdown-preview.nvim",
